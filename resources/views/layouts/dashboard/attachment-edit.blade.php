            ...
            <div class="card card-outline card-primary">
                ...
                <div class="card-body table-responsive">
                    ...
                    <div class="d-flex mb-2">
                        ...
                        <a id="upload_attachment" href="#" data-toggle="modal" data-target="#UPLOAD-ATTACHMENT-MODAL"
                    ...
                    <div class="modal-body">
                        <div class="mb-1">
                            ...
                            <div class="attachments">
                                <input accept="{{ @$data['attachment']['file'][$filetype] }}" type="file"
...
@push('js')
        ...
        function actionGAttachmentDelete(file_id) {
            ...
            Swal.fire({
                ...
                if (result.value == true) {
                    $.ajax({
                        url: "{{ route('cms.attachment.destroy') }}/" + file_id,
                        data: {
                            file_id: file_id,
    ...
    <script>
        ...
        $('#attachmentsubmit').click(function(e) {
            ...
            var url = "{{ route('cms.attachment.store.json') }}";
        ...
        function notificationBeforeDelete(event, el) {
            ...
            Swal.fire({
                ...
                if (result.value == true) {
                    ...
                    $("#delete-form").attr('action', $(el).attr('data-href'));
                    $("#delete-form").submit();
                }
            });
        }
