                ...
                <div class="card-body">
                    <form action="{{ $data['page']['store'] }}" method="POST" autocomplete="off">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col">
                                <label for="valid_to">Tanggal Akhir Kontrak</label>
                                <input {{ $data['page']['readonly'] ? 'readonly' : '' }} type="date"
                                    class="form-control @error('valid_to') is-invalid @enderror" id="valid_to"
                                    placeholder="Tanggal AKhir Kontrak" name="valid_to"
                                    value="{{ isset($param->valid_to) ? $param->valid_to : old('valid_to') }}">
                                @error('valid_to')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-6">
                                ...
                                <select {{ $data['page']['readonly'] ? 'disabled' : '' }} autocomplete="off"
                                    ...
                                    <option @if ((@$param->employee_blood_type ? $param->employee_blood_type : '-') == '-') selected="" @endif value="-"> -
                                    </option>
                                    <option @if ((@$param->employee_blood_type ? $param->employee_blood_type : '-') == 'A+') selected="" @endif value="A+"> A+
                                    </option>
                                    <option @if ((@$param->employee_blood_type ? $param->employee_blood_type : '-') == 'A-') selected="" @endif value="A-"> A-
                                    </option>
                                    <option @if ((@$param->employee_blood_type ? $param->employee_blood_type : '-') == 'B+') selected="" @endif value="B+"> B+
                                    </option>
                                    <option @if ((@$param->employee_blood_type ? $param->employee_blood_type : '-') == 'B-') selected="" @endif value="B-"> B-
                                    </option>
                                    <option @if ((@$param->employee_blood_type ? $param->employee_blood_type : '-') == 'O+') selected="" @endif value="O+"> O+
                                    </option>
                                    <option @if ((@$param->employee_blood_type ? $param->employee_blood_type : '-') == 'O-') selected="" @endif value="O-"> O-
                                    </option>
                                    <option @if ((@$param->employee_blood_type ? $param->employee_blood_type : '-') == 'AB+') selected="" @endif value="AB+"> AB+
                                    </option>
                                    <option @if ((@$param->employee_blood_type ? $param->employee_blood_type : '-') == 'AB-') selected="" @endif value="AB-"> AB-
                                    </option>
                                </select>
        ...
        $(document).ready(function() {
            ...
            if (id.length > 0) {
                ...
                if (list_karyawan_update_premission) {
                    ...
                    $("#nama, #email, #no_ktp, #posisi, #tanggal_akhir_kerja, #valid_to, #email_corporate, #keterangan")
                        .attr("readonly", false);
