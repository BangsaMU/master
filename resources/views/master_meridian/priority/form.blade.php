                ...
                <div class="card__body p-6">
                    <form action="{{ $data['page']['store'] }}" method="POST" autocomplete="off" class="flex flex-col gap-4">
                        ...
                        <div class="field flex flex-col gap-1">
                            <label class="field__label text-sm font-medium text-foreground" for="priority_code">Priority Code</label>
                            <input {{ $data['page']['readonly'] ? 'readonly' : '' }} type="text" name="priority_code" id="priority_code" class="input w-full @error('priority_code') border-danger @enderror"
                        ...
                        <div class="field flex flex-col gap-1">
                            <label class="field__label text-sm font-medium text-foreground" for="priority_name">Priority Name</label>
                            <input {{ $data['page']['readonly'] ? 'readonly' : '' }} type="text" name="priority_name" id="priority_name" class="input w-full @error('priority_name') border-danger @enderror"
                        ...
                        <div class="flex items-center gap-2 mt-4 pt-4 border-t border-border">
                            ...
                            @endif
                            <a href="{{ Route::has('master.priority.index') ? route('master.priority.index') : '#' }}" class="button button--neutral button--outline">
                                Back
                            </a>
                        </div>
                    </form>
