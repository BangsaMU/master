                ...
                <div class="card__body p-6">
                    <form action="{{ $data['page']['store'] }}" method="POST" autocomplete="off" class="flex flex-col gap-4">
                        ...
                        <div class="field flex flex-col gap-1">
                            <label class="field__label text-sm font-medium text-foreground" for="project_code">Vessel Code</label>
                            <input {{ $data['page']['readonly'] ? 'readonly' : '' }} type="text" name="project_code" id="project_code" class="input w-full @error('project_code') border-danger @enderror"
                        ...
                        <div class="field flex flex-col gap-1">
                            <label class="field__label text-sm font-medium text-foreground" for="project_name">Vessel Name</label>
                            <input {{ $data['page']['readonly'] ? 'readonly' : '' }} type="text" name="project_name" id="project_name" class="input w-full @error('project_name') border-danger @enderror"
                        ...
                        <div class="flex items-center gap-2 mt-4 pt-4 border-t border-border">
                            ...
                            @endif
                            <a href="{{ Route::has('master.mcu.index') ? route('master.mcu.index') : '#' }}" class="button button--neutral button--outline">
                                Back
                            </a>
                        </div>
                    </form>
