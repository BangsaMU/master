...
class ApiController extends Controller
{
    ...
    public function getTabelByParams(Request $request, $tabel)
    {
        ...
        // contoh fin in set  mcu-demo.localhost/api/getmcu_packagebyparams?set[text]=name&limit=1&find_in_set[project_id]=2
        ...
        // contoh select2 http://demo-teliti.test:8181/api/gethse_indicator_methodbyparams?set[text]=description&search[type]=vehicle&search[description]=PJP
        // contoh search http://demo-teliti.test:8181/api/gethse_indicator_detailbyparams?&set[field][]=type&limit=13&start=0&search[type]=vehicle&search[indicator_method_id]=4&search[type]=samu
        // contoh multi saerch http://mcu-demo.localhost/api/getmaster_projectbyparams?search[project_code]=21316&search[project_code]=21305&set[field][]=project_code&set[field][]=project_name&set[text]=project_code&set[text][|]=project_code&set[text][]=project_name&ap_token=1fa4a34a49944698769737edf2812b23&_token=ee3Hd8XalXieXGbLtJbChgiYwDax5HkDjkDEwpPR
        // contoh by id http://demo-teliti.test:8181/api/gethse_indicator_methodbyparams?id=45&set[text]=type&set[field][]=description&set[field][]=id
        // contoh get list http://demo-teliti.test:8181/api/gethse_indicator_methodbyparams?set[text]=type&set[field][]=description&set[field][]=id
